...
script.registerModule({
    name: "RedeManager",
    description: "Loads Redesky configs",
    category: "Fun",
    tag: "Redesky",
    settings: {
        B73: Setting.boolean({
            name: "LoadRedeskyNewv8",
            default: false
		}),
        B72: Setting.boolean({
    ...
    commandManager.executeCommands(".config load https://raw.githubusercontent.com/br-22448/RedeskyNew/Configs/redeskynewv8");
